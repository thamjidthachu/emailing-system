"""
Django settings for emailing_system project.
...
SECRET_KEY = 'django-insecure-v$vfc!0^khfs&rkcr*r3g5rwn*vy_cr8(8=6kg9bnn*6mg(3-@'
...
ROOT_URLCONF = 'emailing_system.urls'
...
WSGI_APPLICATION = 'emailing_system.wsgi.application'
